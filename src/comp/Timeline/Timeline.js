...
const Timeline = () => {
  return (
    <div className="tt-card-container relative font-inter antialiased" id="timeline">
      <main className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        <div className="flex items-center justify-center">
          <p className="text-5xl font-caveat font-bold text-white underline">Timeline</p>
        </div>
              ...
              <div className="-my-2">
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                    ...
                    <div className="lg:text-[20px] text-[15px] font-bold text-slate-900 text-white">Acme was founded in Milan, Italy</div>
                  </div>
                  {/* Content */}
                  <div className="lg:text-[16px] text-[12px] text-slate-500 text-white">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</div>
                </div>
                {/* Item #2 */}
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  {/* Purple label */}
                  ...
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                    ...
                    <div className="lg:text-[20px] text-[15px] font-bold text-slate-900 text-white">Reached 5K customers</div>
                  </div>
                  {/* Content */}
                  <div className="lg:text-[16px] text-[12px] text-slate-500 text-white">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</div>
                </div>
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                    ...
                    <div className="lg:text-[20px] text-[15px] font-bold text-slate-900 text-white">Acquired various companies, including Technology Inc.</div>
                  </div>
                  {/* Content */}
                  <div className="lg:text-[16px] text-[12px] text-slate-500 text-white">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</div>
                </div>
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                    ...
                    <div className="lg:text-[20px] text-[15px] font-bold text-slate-900 text-white">Acme went public at the New York Stock Exchange</div>
                  </div>
                  {/* Content */}
                  <div className="lg:text-[16px] text-[12px] text-slate-500 text-white">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</div>
                </div>
