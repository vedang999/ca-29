...
const ResponsibilityCard = ({ title, description, imageUrl }) => {
  return (
    <div className="bg-opacity-80 block rounded-lg border shadow-xl border-gray-800 p-40 m-8 hover:scale-105 duration-150 transform cursor-pointer transition hover:border-pink-500/10 hover:shadow-pink-500/10">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br bg-opacity-80">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-white mb-10">Responsibilities of CA</h1>
